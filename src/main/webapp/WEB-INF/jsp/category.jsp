         ...
         <div class="col-sm-4">
                <div class="card my-1">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                                                                   <button type="button" id="categoryUpdateModal" data-toggle="modal" data-target="#editCategoryModal" data-name="${category.name}" data-id="${category.id}" class="btn btn-primary btn-sm" >Edit</button>
    ...
    <div class="col-sm-4">
                    <div class="card my-1">
                      ...
                      <div class="card-body">
                        ...
                        <button id="userUpdateModal" type="button" class="btn btn-sm btn-outline-secondary"  data-toggle="modal" data-target="#addCategory">
