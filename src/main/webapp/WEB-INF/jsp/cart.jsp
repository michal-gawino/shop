...
<t:page>
    <div class="container">
                                ...
                                <div class="card-body">
                                    ...
                                    <form:form method="DELETE" action="/cart/${product.id}">
                                        <div class="btn-group" role="group">
                                            <button type="submit" class="btn btn-secondary btn-danger">Remove</button>
        ...
        <c:if test="${!sessionScope.cart.products.isEmpty()}">
            <a href="/order" class="btn btn-primary btn-md active float-right" role="button">Order</a>
        </c:if>
    </div>
</t:page>