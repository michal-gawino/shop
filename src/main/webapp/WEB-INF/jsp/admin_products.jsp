     ...
     <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th scope="col"><button type="submit" data-toggle="tooltip" title="Remove selected products" class="btn btn-danger">
                    ...
                    <c:forEach items="${products}" var="product" varStatus="var">
                      <tr>
						...
						<div class="form-check">
                            <input class="form-check-input" type="checkbox" value="${product.id}" name="productsToDelete">
						</div>
                        </td>
                        <td>                              <button id="productUpdateModal" type="button" class="btn btn-success" data-id="${product.id}" data-category="${product.category.id}" data-brand="${product.brand}" data-price="${product.price}" data-name="${product.name}" data-toggle="modal" data-target="#editProductModal">
